...
#include "../../build/proto/common.pb.h"
...
class RawCoprocessor {
 public:
  ...
  virtual butil::Status GetResultFromRecord(const std::vector<std::any>& record, bool* has_result_kv, pb::common::KeyValue* result_kv);
  virtual void Close();
};
